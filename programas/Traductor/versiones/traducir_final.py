...
class TraductorThread(QThread):
    ...
    def traducir_con_api(self, texto, api_info):
        """Traduce usando una API específica"""
        ...
        elif api_info["nombre"].startswith("LibreTranslate"):
...
class ConfiguracionTraductor:
    ...
    URLS_APIS = {
        ...
        "LibreTranslate2": "https://translate.argosopentech.com/translate",
        "LibreTranslate3": "https://translate.fortytwo-it.com/translate",
        "LibreTranslate4": "https://translate.terraprint.co/translate",
        "LibreTranslate5": "https://translate.mentality.rip/translate",
