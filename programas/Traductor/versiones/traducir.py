    ...
    def traducir_texto(self, texto):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log.emit(f"⚠️ Error al traducir: {response.status_code} - {response.text}")
                return texto
...
class TraductorGUI(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Traductor de archivos .rpy (PyQt5)")
    ...
    def init_ui(self):
        ...
        titulo = QLabel("Traductor de archivos .rpy")
    ...
    def iniciar_traduccion(self):
        ...
        self.progress.setValue(0)
        self.log_area.clear()
        self.traductor_thread = TraductorThread(archivo_entrada, archivo_salida)
